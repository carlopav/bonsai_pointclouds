...
def write(
    ...
    # Mode ("L"/"LA"/"RGB"/"RGBA") is inferred from the pixel array shape —
    # the caller does not declare it.
    ndim = pixels.ndim
    if ndim == 2:
    ...
    geokey_data = struct.pack(
        ...
        1,
        0,
        3,  # KeyDirectoryVersion=1, KeyRevision=1, Minor=0, NKeys=3
        1024,
        0,
        1,
        32767,  # GTModelTypeGeoKey = 32767 (user-defined / local)
        1025,
        0,
        1,
        ...
        0,
        1,
        9001,  # ProjLinearUnitsGeoKey = 9001 (metre)
    )
